...
function Sidebar({ view, trips, nav, openTrip, cloudState }) {
  return <aside className="sidebar">
    ...
    <div className="sync-card"><i className={cloudState} /><div><strong>{syncLabel(cloudState)}</strong><small>{cloudState === "local" ? "Tersimpan di perangkat" : "Workspace pribadi"}</small></div></div>
  </aside>;
}
